...
class PHPMailer {
  ...
  /**
   * Sets SMTP authentication. Utilizes the email and Password variables.
   * @var bool
   */
    ...
    try {
      while($index < count($hosts) && !$connection) {
        ...
        if ($this->smtp->Connect(($ssl ? 'ssl://':'').$host, $port, $this->Timeout)) {
          ...
          $connection = true;
          if ($this->SMTPAuth) {
            if (!$this->smtp->Authenticate($this->email, $this->Password, $this->AuthType, $this->Realm, $this->Workstation)) {
