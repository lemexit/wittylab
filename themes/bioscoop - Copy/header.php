  ...
  <body<?php echo Main::body_class() ?>>
   ...
   <header id="header" style="background: #0A1725;">
      <div class="container">
          <div class="row">
              ...
              <div class="col-sm-3 col-xs-12">
                  <div class="head-pro">
                      <div class="dropdown">
                          <a class="dropdown-toggle user-link"  data-toggle="dropdown" href="<?php echo Main::href("user") ?>">
                              <div class="user-box">
                                  <img src="<?php echo $this->avatar($this->user) ?>" alt="<?php echo $this->user->profile->id ?>" class="img img-circle img-responsive">
                              </div>
    ...
    <section class="menu">
      <div class="hor-menu">
          <ul>
              <li class="active"><a href="<?php echo Main::href()?>"><i class="fa fa-television"></i></a></li>
              <li><a href=""><i class="fa fa-th-large"></i></a></li>
              <li><a href="<?php echo Main::href("user/{$this->user->username}") ?>"><i class="fa fa-user"></i></a></li>
          </ul>
      </div>
  </section>
  <?php endif;?>
